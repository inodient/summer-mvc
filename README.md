...
- HTTP POST :
  1. HTTP GET : http://{user_hostname}:{port}/post?action=initial
  2. Type "initial" and Submit
  3. HTTP POST called and send HTTP GET http://{user_hostname}:{port}/welcomePost
